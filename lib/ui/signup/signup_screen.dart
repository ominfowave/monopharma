                     ...
                     TextFieldWrapper(
                       ...
                       validator: (value) {
                         if (value == null || value.isEmpty) {
                           ...
                           return CustomString.errorValidEmail; // Validation for format
                         }
                         return null;
                       },
                     ),
                     ...
                     GestureDetector(
                       ...
                       child: Container(
                         ...
                         child: Padding(
                           ...
                           child: Center(child: TextWrapper(textShow: CustomString.signUp,height: 0,textColor: CustomColor.white,fontWeight: FontWeight.bold,fontSize: 14,)),
                         ),
                       ),
                     ),
                     const SizedBox(
